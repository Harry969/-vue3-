export const appName = 'Harry'
export const appDescription = 'Harry Web App'
...
export const SITE = {
  title: '博客',
  author: 'Harry',
  description: '记录 Harry 的不枯燥生活',
  profileContent: '我是Harry，目前生活在鞍山的开发者。我很喜欢 Vue、Java、Golang、Docker、K8s。目前正在学习。',
  keywords: 'Harry, Blog, 前端, Vue, 博客',
  ...
  cv: 'https://cv.harry.ocybers.com/',
  juejin: 'https://juejin.cn/user/149189314490520/posts',
  mail: 'mailto:2545589993@qq.com',
  homePage: '/',
  profilePage: '/profile',
  twitterId: 'HarrynWang',
  twitterUrl: 'https://twitter.com/HarrynWang',
  githubId: 'pinky-pig',
  githubHome: 'https://github.com/pinky-pig',
  weeklyUrl: 'https://weekly.harry.ocybers.com/',
...
export const PROJECTS = [
  {
    ...
    demoUrl: 'https://harry.ocybers.com/',
    repoUrl: 'https://github.com/pinky-pig/Harry',
  },
  {
    ...
    demoUrl: 'https://superellipse.harry.ocybers.com/',
  ...
  },
  {
    ...
    demoUrl: 'https://encodesvg.harry.ocybers.com/',
  ...
  },
  {
    ...
    demoUrl: 'https://html2particle.harry.ocybers.com/guide/demo.html',
  ...
  },
  {
    ...
    demoUrl: 'https://dragblock.harry.ocybers.com/',
  ...
  },
  {
    ...
    demoUrl: 'https://mousetrail.harry.ocybers.com/',
  ...
  },
  {
    ...
    demoUrl: 'https://love.harry.ocybers.com/',
  ...
  },
  {
    ...
    demoUrl: 'https://holiday.harry.ocybers.com/',
  ...
  },
  {
    ...
    demoUrl: 'https://scene.harry.ocybers.com/',
...

  {
    ...
    demoUrl: 'https://playground.harry.ocybers.com/',
